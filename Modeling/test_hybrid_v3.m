...
p = parameters();
z0 = [0, -120/360*2*pi, -pi, 0, 0, 0]';
% z0 = [0, 0, 0, -0.3, 0, 0, 0, 0]';
% z0 = [0, 0/360*2*pi, -90/360*2*pi, -pi, 0, 0, 0, 0]';
...
%% Ignore ctrl.T1/T2 for now - required to run, not used
tspan = [0 1];
ctrl.tf = 0.00;
ctrl.T1 = [0.0 0.0 0.0];
ctrl.T2 = [-19 -9.0 -0.0];

[tout, zout, uout, indices] = hybrid_simulation_v3(z0, ctrl, p, tspan);

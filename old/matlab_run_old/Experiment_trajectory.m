function output_data = Experiment_trajectory( R_angle1_init, R_angle2_init,...
    L_angle1_init, L_angle2_init, R_pts_foot, L_pts_foot, num_cycles, traj_time,...
    pre_buffer_time, post_buffer_time, gains, duty_max)
    ...
    input = [input R_angle1_init R_angle2_init];
    input = [input L_angle1_init L_angle2_init];
    input = [input K_xx K_yy K_xy D_xx D_yy D_xy];
    input = [input duty_max];
    input = [input num_cycles];    
    input = [input R_pts_foot(:)'];
    input = [input L_pts_foot(:)'];
